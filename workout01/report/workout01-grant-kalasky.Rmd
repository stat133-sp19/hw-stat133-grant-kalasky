...
We then group our data by each player and calculate the following statistics:
- total: the total number of shots a given player took during the 2016-2017 season
- made: the number of shots taken that were "makes"
- percentage: the proportion of shots taken that were "makes"
...
The graphic above illustrates not only where on the court the Warriors are taking their shots, it also highlights where each player is most effective on the court (in terms of scored points). 
...
This shooting style underscores a larger trend with the Warriors top-performing players. While the team's top-five players have different shooting preferences in terms of location of shot, they all are statistically consistent. The number of shots that these players take from areas they are strongest in, whether it be close to the basket or back behind the 3-Point line, are mostly scored baskets for the team. This is what makes the Warriors such a dominant team within the NBA - their ability to recognize areas on the court they are most statistically likely to make, and capitalizing on those areas during their games. 
